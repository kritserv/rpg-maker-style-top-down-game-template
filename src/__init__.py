from .variable import clock_tick, curr_fps,\
	...
	default_screen_size, black, darkblue, font_x1, font_x2, font_x3, font_x4
...
__all__ = [clock_tick, curr_fps, default_screen_width, default_screen_height, default_screen_size, black, darkblue, font_x1, font_x2, font_x3, font_x4, 
